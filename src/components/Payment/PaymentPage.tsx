...
// Interface pour accepter la fonction de retour vers l'accueil
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-white flex flex-col font-sans pb-20">
      ...
      <header className="flex items-center justify-center relative px-6 py-6">
        {/* Bouton retour qui appelle la fonction onBack */}
        <button 
          onClick={onBack}
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-[#0d1b2e] border-t border-gray-800 px-2 py-3 z-50">
        <div className="flex justify-around items-center max-w-md mx-auto">
          {/* Le bouton Accueil de la navigation appelle aussi onBack pour retourner au tableau de bord */}
          <button onClick={onBack} className="flex flex-col items-center gap-1 text-gray-400 hover:text-white transition">
